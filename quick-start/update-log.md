...
10. 消息网关增加集群支持,在任意一个服务节点都可订阅设备消息.(PRO)
11. 增加UDP设备网关,可通过UDP接入设备了(PRO).
12. 增加CoAP设备网关,可通过CoAP接入设备了(PRO).
13. 设备会话支持手动指定心跳超时时间以及获取客户端地址信息.
14. 性能优化,详见[压力测试](../advancement-guide/benchmark.md).
15. 一系列UI优化.
