...
![设备型号属性信息2](images/device/model-attribute2.png)
...
![设备型号功能信息](images/device/model-functions.png)
...
![设备型号事件信息](images/device/model-events.png)
...
![设备型号事件信息](images/device/model-json.png)
