...
<div class='explanation primary'>
  ...
  <p>默认情况下使用tcp和mqtt方式接入时,当连接断开时,则认为设备已离线。</p>
...
<table>
<tr>
    <td><a href="/dev-guide/sort-link.html#平台下发指令给短连接设备">平台下发指令给短连接设备</a></td>
</tr>
</table>
...
<div class='explanation primary'>
  ...
  <p>MQTT接入时添加到任意消息即可。TCP接入时添加到<b class='explanation-title font-weight'>DeviceOnlineMessage</b>即可。</p>
  <p>如果服务重启，将不会保持在线状态！</p>
...
`org.jetlinks.core.message.Headers`: 平台设备消息头统一约定接口，提供消息头参数设置。
