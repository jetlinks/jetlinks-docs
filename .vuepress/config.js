        ...
        sidebar: [
            ...
            },
            {
                ...
                children: [
                    ...
                    ['/dev-guide/pull-code.md', '拉取源码及更新子模块'],
                    ['/dev-guide/ui-deploy.md', '前端部署及常见问题'],
                    ['/dev-guide/middleware-deploy.md', '中间件部署及常见问题'],
                    ['/dev-guide/custom-functions.md', '自定义业务功能'],
                    ['/dev-guide/custom-sql-term.md', '自定义通用SQL条件'],
                    ['/dev-guide/custom-use-es.md', '自定义模块使用ElasticSearch'],
                    ['/dev-guide/custom-use-eventbus.md', '自定义模块使用消息总线'],
                    ['/dev-guide/protocol-redis.md', '协议包中使用Redis'],
                    ['/dev-guide/event-driver.md', '事件驱动,消息总线'],
                    ['/dev-guide/reactor-ql.md', 'ReactorQL,使用SQL处理实时数据.'],
                    ['/dev-guide/rule-engine.md', '规则引擎说明'],
                    ['/dev-guide/storage-strategy.md', '存储策略说明'],
                    ['/dev-guide/custom-storage-strategy.md', '添加自定义存储策略'],
                   ...
                   // ['/dev-guide/send-message.md', '向设备发送消息'],
                    ...
                    ['/dev-guide/listen-execute-service.md', '监听实体并触发业务'],
                    ['/dev-guide/cluster.md', '集群管理'],
                    ['/dev-guide/sort-link.md', '短连接接入平台'],
                    ['/dev-guide/push-middleware.md', '设备数据推送到消息中间件'],
                    ['/dev-guide/subscribe-mqtt.md', '使用MQTT订阅平台相关消息'],
                    ['/dev-guide/third-request-interface.md', '第三方平台请求JetLinks服务接口'],
                    ['/dev-guide/signature-token.md', '获取平台签名及token'],
